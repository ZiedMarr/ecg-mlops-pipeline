...
def is_data_ready(save_path):
    return os.path.isfile(os.path.join(save_path, "manifest.json"))
...
def main():
    ...
    if is_data_ready(save_path):
        print(f"Data already processed for fingerprint {fingerprint} — skipping.")
    else:
